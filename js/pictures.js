...
var pgal = {
    0 : [], N : 0, S : 0, img : 0, span : 0, xm : 0, ym : 0, nx : 0, ny : 0, nw : 0, nh : 0,
    ...
    PGObj : function(n) {
        ...
        this.oxt.style.zIndex = this.obj.style.zIndex = Math.round(100000 - this.z);
        this.F = false;
        this.CF = 100;
        this.sto = [];
        this.anim = function() {
            ...
            if(f>0) {
                ...
                this.oxs.visibility = (this.CF--> 0 && Math.random() > .9) ? "hidden" : "visibile";
                ...
                if((pgal.zt - pgal.z) < 20) {
                    if(!this.F) {
                        ...
                        this.oxs.fontSize = to+pageXOffset(1+d*20*pgal.zoom);
                        var T = "";
...
//event handlers 
window.onresize = g_rise;
document.onmousemove = function(e) {
    if(window.event) e=indow.event;
